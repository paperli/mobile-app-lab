...
export const SystemButton = forwardRef<HTMLButtonElement, SystemButtonProps>(
  ({ variant, gameLogo, onPress, size = 44, 'aria-label': ariaLabel }, ref) => {
    return (
      <button
        ref={ref}
        type="button"
...
// Weekend "W in sun" mark — ported from packages/mobile/src/components/IconSystem.tsx
function WeekendMark({ size = 56 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g filter="url(#wsb_f)">
        <g clipPath="url(#wsb_c)">
          ...
          <path d="M4 32C4 16.536 16.536 4 32 4C47.464 4 60 16.536 60 32C60 47.464 47.464 60 32 60C16.536 60 4 47.464 4 32Z" fill="url(#wsb_g1)" style={{mixBlendMode:'multiply'}}/>
          ...
          <ellipse cx="32.0002" cy="16.6667" rx="44.6667" ry="20.6667" fill="url(#wsb_g2)" style={{mixBlendMode:'screen'}}/>
        </g>
      ...
      <defs>
        <filter id="wsb_f" x="0" y="0" width="64" height="64" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        ...
        <linearGradient id="wsb_g1" x1="32" y1="4" x2="32" y2="60" gradientUnits="userSpaceOnUse">
          <stop stopColor="white"/>
          <stop offset="0.525276" stopColor="white"/>
          <stop offset="1" stopColor="#E0E0E0"/>
        </linearGradient>
        <linearGradient id="wsb_g2" x1="32.0002" y1="-0.820513" x2="32.0002" y2="37.3333" gradientUnits="userSpaceOnUse">
